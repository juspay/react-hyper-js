...
function HyperManagementElements(props) {
  ...
  React.useEffect((function () {
          Core__Promise.$$catch(Promise.all([
                    ...
                    var paymentMethodsManagementElementOptions = Context.paymentMethodsManagementElementsOptionObjMapper(resolvedOptions);
                    var orcaElementsConfig = switchInstance.paymentMethodsManagementElements(resolvedOptions);
